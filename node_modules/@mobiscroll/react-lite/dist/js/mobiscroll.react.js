(function (global, factory) {
  ...
  var Input = function (_FormControl) {
      ...
      function Input(elm, settings) {
          ...
          var $elm = _this._$elm;
          var $dummy = _this._$parent.find('.mbsc-select-input');

          addIconToggle(_this, _this._$parent, $elm);

          if (elm.type == 'file') {
              // Copy attributes and create dummy input
              var $inp = $$2('<input type="text" class="' + ($elm.attr('class') || '') + '" placeholder="' + ($elm.attr('placeholder') || '') + '"/>').insertAfter($elm);
          ...
          _this.checkLabel = _this.checkLabel.bind(_this);

          // Attach events
          events.forEach(function (ev) {
              $elm.on(ev, _this.checkLabel);
          });
      ...
      createClass(Input, [{
          ...
          value: function destroy() {
              ...
              events.forEach(function (ev) {
                  _this2._$elm.off(ev, _this2.checkLabel);
              });
          }
      }]);
      return Input;
  ...
  var events$2 = ['keydown', 'input', 'scroll'];
      ...
      createClass(MbscCheckbox, [{
          ...
          value: function render() {
              ...
              var _props7 = this.props,
                  ...
                  other = _objectWithoutProperties$1(_props7, ['color', 'children', 'inputStyle']);
              /* eslint-enable */

              return React.createElement(MbscLabel, { color: color, presetName: 'checkbox' }, React.createElement('input', _extends$2({ ref: this.inputMounted, type: 'checkbox' }, other)), children);
          }
      }]);
      return MbscCheckbox;
      ...
      createClass(MbscRadio, [{
          ...
          value: function render() {
              ...
              var _props8 = this.props,
                  ...
                  other = _objectWithoutProperties$1(_props8, ['color', 'children', 'inputStyle']);
              /* eslint-enable */

              return React.createElement(MbscLabel, { color: color, presetName: 'radio' }, React.createElement('input', _extends$2({ ref: this.inputMounted, type: 'radio' }, other)), children);
          }
      }]);
      return MbscRadio;
      ...
      createClass(MbscFormBase, [{
          ...
          value: function render() {
              ...
              var _props10 = this.props,
                  ...
                  other = _objectWithoutProperties$1(_props10, ['className', 'children', 'value', 'checked', 'onChange', 'name', 'color', 'labelStyle', 'inputStyle']);

              /* eslint-enable no-unused-vars */

              var type = this.inputType || 'text';
              return React.createElement(MbscLabel, { inputStyle: inputStyle, labelStyle: labelStyle }, children, React.createElement('input', _extends$2({ ref: this.inputMounted, type: type, 'data-role': name, 'data-enhance': 'false' }, other)));
          }
      }]);
      return MbscFormBase;
